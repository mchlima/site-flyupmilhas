  ...
  <section id="sobre" class="gradient-section-about py-12 md:py-24 px-6">
    <div class="max-w-5xl mx-auto">
      ...
      <div class="relative bg-brand-dark rounded-xl p-6 md:p-8 w-full my-10 overflow-hidden">
        <img src="~/assets/img/logo-fly-up-milhas.png" alt="" aria-hidden="true" class="absolute right-4 top-1/2 -translate-y-1/2 w-72 md:w-96 opacity-5 pointer-events-none" />
